...
class ConfigurationGenerator {
	...
	def String generateConfVars() {
		return confVarList.generateVars
	}
	
	def String generateConfVarDecl() {
		return confVarList.generateVarDecl
	}
	
	def String generateResources() '''
		«FOR r : resources»
			«r.generateResource»
		«ENDFOR»
	'''
	
	def String generateResDecl() '''
		«FOR r : resources»
			«r.generateResVarDecl»
		«ENDFOR»
	'''
