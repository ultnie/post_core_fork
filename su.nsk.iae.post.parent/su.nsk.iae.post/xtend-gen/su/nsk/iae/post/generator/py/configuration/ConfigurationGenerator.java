...
public class ConfigurationGenerator {
  ...
  public String generateConfVars() {
    return GeneratorUtil.generateVars(this.confVarList);
  }

  public String generateConfVarDecl() {
    return GeneratorUtil.generateVarDecl(this.confVarList);
  }
  ...
  public String generateResDecl() {
    StringConcatenation _builder = new StringConcatenation();
    {
      for(final ResourceGenerator r : this.resources) {
        CharSequence _generateResVarDecl = r.generateResVarDecl();
        _builder.append(_generateResVarDecl);
        _builder.newLineIfNotEmpty();
      }
    }
    return _builder.toString();
